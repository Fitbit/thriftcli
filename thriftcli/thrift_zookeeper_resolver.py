...
class ThriftZookeeperResolver(object):
    ...
    def get_server_address(zookeeper_address, service_name):
        ...
        znode = ThriftZookeeperResolver._get_znode_from_zookeeper_host(host, url_obj.path)
        return ThriftZookeeperResolver._parse_znode_for_address(znode, service_name, url_obj.path)
