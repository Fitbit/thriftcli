...
TEST_THRIFT_SERVICE_DEFINITION3 = textwrap.dedent("""\
    ...
    }""" % (TEST_THRIFT_SERVICE_NAME3, TEST_THRIFT_STRUCT_NAME, TEST_THRIFT_STRUCT_NAME))
...
TEST_CLI_ARGS2 = [TEST_CLI_NAME, TEST_SERVER_ADDRESS, TEST_THRIFT_ENDPOINT_NAME, TEST_THRIFT_PATH,
                  '-b', TEST_JSON_PATH]
...
TEST_PARSED_ARGS = (TEST_SERVER_ADDRESS, TEST_THRIFT_ENDPOINT_NAME, TEST_THRIFT_PATH, [], {})
TEST_PARSED_ARGS2 = (TEST_SERVER_ADDRESS, TEST_THRIFT_ENDPOINT_NAME, TEST_THRIFT_PATH, [], TEST_JSON)
TEST_PARSED_ARGS3 = (TEST_SERVER_ADDRESS, TEST_THRIFT_ENDPOINT_NAME, TEST_THRIFT_PATH,
                     [TEST_THRIFT_DIR_PATH, TEST_THRIFT_DIR_PATH2], {})
TEST_PARSED_ARGS4 = (TEST_SERVER_ADDRESS, TEST_THRIFT_ENDPOINT_NAME, TEST_THRIFT_PATH,
                     [TEST_THRIFT_DIR_PATH, TEST_THRIFT_DIR_PATH2], TEST_JSON)
