...
TEST_ZNODE = ('{"serviceEndpoint": {"host": "%s", "port": %s}, "status": "ALIVE", "shard": 0}' %
              (TEST_SERVER_HOSTNAME2, TEST_SERVER_PORT2),
              None)
...
TEST_PARSED_ARGS = (TEST_SERVER_ADDRESS, TEST_THRIFT_ENDPOINT_NAME, TEST_THRIFT_PATH, [], {}, False)
...
TEST_PARSED_ARGS3 = (TEST_SERVER_ADDRESS, TEST_THRIFT_ENDPOINT_NAME, TEST_THRIFT_PATH,
                     [TEST_THRIFT_DIR_PATH, TEST_THRIFT_DIR_PATH2], {}, False)
TEST_PARSED_ARGS4 = (TEST_SERVER_ADDRESS, TEST_THRIFT_ENDPOINT_NAME, TEST_THRIFT_PATH,
                     [TEST_THRIFT_DIR_PATH, TEST_THRIFT_DIR_PATH2], TEST_JSON, False)
